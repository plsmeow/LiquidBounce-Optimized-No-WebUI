...
object ClientRenderPipelines {
    ...
    /**
     * Blend mode for premultiplied alpha blending.
     */
    private val PREMULTIPLIED_ALPHA_BLEND = BlendFunction.TRANSLUCENT_PREMULTIPLIED_ALPHA
    ...
    object Overlay {
        @JvmField
        val SMOOTH_TEXTURE = newPipeline("overlay/smooth_texture") {
         ...
         */
        @JvmField
        val Blit = newPipeline("overlay_blit") {
            screenQuadSnippet()
            withFragmentShader("core/blit_screen")
            withBindGroupLayout(BindGroupLayouts.IN_SAMPLER)
            withColorTargetState(
                ColorTargetState(
                    optional(PREMULTIPLIED_ALPHA_BLEND),
